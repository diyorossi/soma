                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="<?php echo e($hero->title ?? ''); ?>" required>
                        </div>
                        
                        <div class="mb-3">
                            <label for="subtitle" class="form-label">Subtitle</label>
                            <textarea class="form-control" id="subtitle" name="subtitle" rows="3"><?php echo e($hero->subtitle ?? ''); ?></textarea>
                        </div>
                        
                        <div class="mb-3">
                            <label for="cta_text" class="form-label">CTA Button Text</label>
                            <input type="text" class="form-control" id="cta_text" name="cta_text" value="<?php echo e($hero->cta_text ?? ''); ?>">
                        </div>
                        
                        <div class="mb-3">
                            <label for="cta_link" class="form-label">CTA Button Link</label>
                            <input type="url" class="form-control" id="cta_link" name="cta_link" value="<?php echo e($hero->cta_link ?? ''); ?>" placeholder="https://example.com">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="image-preview-container" style="border: 2px dashed #ddd; border-radius: 10px; padding: 20px; text-align: center; min-height: 200px;">
                                <?php if(isset($hero->background_image) && $hero->background_image): ?>
                                    <img id="imagePreview" src="<?php echo e(asset('storage/' . $hero->background_image)); ?>" style="max-width: 100%; max-height: 300px; border-radius: 8px;">
                                <?php else: ?>
                        ...
                        <div class="form-check mb-3">
                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" <?php echo e(isset($hero->is_active) && $hero->is_active ? 'checked' : ''); ?>>
...
<script>
    ...
    document.getElementById('heroForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("admin.hero.update", $hero->id ?? 1)); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/soma/resources/views/admin/hero/index.blade.php ENDPATH**/ ?>