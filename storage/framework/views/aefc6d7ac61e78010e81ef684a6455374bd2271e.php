...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> | SMAgency</title>
...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <div class="sidebar-item">
            <a href="<?php echo e(route('admin.whatwedo.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.whatwedo.*') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-item">
            <a href="<?php echo e(route('landing')); ?>" class="sidebar-link" target="_blank">
...
</html><?php /**PATH /var/www/html/soma/resources/views/layouts/admin.blade.php ENDPATH**/ ?>