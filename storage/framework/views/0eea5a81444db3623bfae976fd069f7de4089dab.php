...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="btn-group" role="group">
                ...
                <button type="button" class="btn btn-outline-custom" onclick="filterPortfolio('<?php echo e(Str::slug($category)); ?>')"><?php echo e($category); ?></button>
    ...
    <div class="row" id="portfolioGrid">
        <?php $__empty_1 = true; $__currentLoopData = $works ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="col-md-6 col-lg-4 col-xl-3 mb-4 portfolio-item" data-category="<?php echo e(Str::slug($item->category)); ?>">
            <div class="card h-100">
                <div class="position-relative">
                    <?php if($item->image): ?>
                    <img src="<?php echo e(asset('storage/' . $item->image)); ?>" class="card-img-top" style="height: 200px; object-fit: cover;">
                    <?php else: ?>
                    ...
                    <div class="position-absolute top-0 end-0 p-2">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="#" onclick="editPortfolio(<?php echo e($item->id); ?>)"><i class="fas fa-edit me-2"></i>Edit</a></li>
                                <li><a class="dropdown-item text-danger" href="#" onclick="deletePortfolio(<?php echo e($item->id); ?>)"><i class="fas fa-trash me-2"></i>Delete</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <span class="badge bg-success mb-2"><?php echo e($item->category ?? 'Uncategorized'); ?></span>
                    <h5 class="card-title"><?php echo e($item->title); ?></h5>
                    <p class="card-text text-muted"><?php echo e(Str::limit($item->description, 80)); ?></p>
                    <?php if($item->client_name): ?>
                    <small class="text-muted"><i class="fas fa-user me-1"></i><?php echo e($item->client_name); ?></small>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="category" name="category" required>
                                    ...
                                    <?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(!in_array($category, ['Web Development', 'Mobile App', 'UI/UX Design', 'Branding', 'Digital Marketing', 'Other'])): ?>
...
<script>
    ...
    document.getElementById('portfolioForm').addEventListener('submit', function(e) {
        ...
        const url = portfolioId ? 
            '<?php echo e(route("admin.portfolio.update", "")); ?>/' + portfolioId :
            '<?php echo e(route("admin.portfolio.store")); ?>';
    ...
    function editPortfolio(id) {
        fetch('<?php echo e(route("admin.portfolio.show", "")); ?>/' + id)
            .then(response => response.json())
            .then(data => {
                if (data.success) {
                    ...
                    if (item.image) {
                        document.getElementById('imagePreview').src = '<?php echo e(asset("storage")); ?>/' + item.image;
    ...
    function deletePortfolio(id) {
        confirmDelete(function() {
            fetch('<?php echo e(route("admin.portfolio.destroy", "")); ?>/' + id, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': csrfToken,
    ...
    function addPortfolioCard(item) {
        ...
        const imageUrl = item.image ? '<?php echo e(asset("storage")); ?>/' + item.image : '';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/soma/resources/views/admin/portfolio/index.blade.php ENDPATH**/ ?>