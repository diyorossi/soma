        ...
        <div class="card-body">
            <div id="socialList">
                @if($socialLinks->count() > 0)
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3 p-2 border rounded" id="social-{{ $social->id }}">
        ...
        <div class="card-body">
            <form id="mapForm">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="map_embed" name="map_embed" rows="4" placeholder='<iframe src="https://www.google.com/maps/embed?..." ...></iframe>'>{{ $contact->map_embed ?? '' }}</textarea>
            ...
            @if(isset($contact->map_embed) && $contact->map_embed)
            <div class="mt-4">
...
<script>
    ...
    document.getElementById('contactForm').addEventListener('submit', function(e) {
        ...
        fetch('{{ route("admin.contact.update", $contact->id ?? 1) }}', {
            method: 'POST',
            headers: {
    ...
    document.getElementById('socialForm').addEventListener('submit', function(e) {
        ...
        const url = socialId ? 
            '{{ route("admin.contact.social.update", "") }}/' + socialId :
            '{{ route("admin.contact.social.store") }}';
    ...
    function editSocial(id) {
        fetch('{{ route("admin.contact.social.show", "") }}/' + id)
            .then(response => response.json())
            .then(data => {
                if (data.success) {
    ...
    function deleteSocial(id) {
        confirmDelete(function() {
            fetch('{{ route("admin.contact.social.destroy", "") }}/' + id, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': csrfToken,
