                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="image-preview-container" style="border: 2px dashed #ddd; border-radius: 10px; padding: 20px; text-align: center; min-height: 200px;">
                                @if(isset($about->image) && $about->image)
                                    <img id="imagePreview" src="{{ asset('storage/' . $about->image) }}" style="max-width: 100%; max-height: 300px; border-radius: 8px;">
                                @else
                        ...
                        <div class="form-check mb-3">
                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" {{ isset($about->is_active) && $about->is_active ? 'checked' : '' }}>
...
<script>
    ...
    document.getElementById('aboutForm').addEventListener('submit', function(e) {
        ...
        fetch('{{ route("admin.about.update", $about->id ?? 1) }}', {
            method: 'POST',
            headers: {
