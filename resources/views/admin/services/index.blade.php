                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="section_label" name="label" value="{{ $serviceSection->label ?? 'Our Services' }}" required>
                    ...
                    <div class="col-md-5">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="section_title" name="title" value="{{ $serviceSection->title ?? 'What We Offer' }}" required>
                            <small class="text-muted">The main large title for the services grid.</small>
                        </div>
                    </div>
...
<script>
    ...
    document.getElementById('sectionHeaderForm').addEventListener('submit', function(e) {
        ...
        // We append _method manually because Laravel expects PUT for updates
        formData.append('_method', 'PUT');
        
        submitBtn.disabled = true;
        spinner.classList.remove('d-none');
        
        fetch('{{ route("admin.services.section.update") }}', {
            method: 'POST',
            headers: {
    ...
    document.getElementById('serviceForm').addEventListener('submit', function(e) {
        ...
        const url = serviceId ? 
            '{{ route("admin.services.update", "") }}/' + serviceId :
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                // Handle Laravel 422 validation errors gracefully
                let errorMsg = data.message || 'Failed to save service.';
                if (data.errors) {
                    const firstError = Object.values(data.errors)[0][0];
                    errorMsg = firstError;
                }
    ...
    function editService(id) {
        fetch('{{ route("admin.services.show", "") }}/' + id)
